...
<div class="main">
  <h2><span class="glyphicon glyphicon-menu-right"></span>&nbsp;Product Details</h2>
  <ul class="breadcrumb">
    <li><a href="{{url('admin/home')}}">Home</a></li>
    <li><a href="{{url('admin/servicedetails/product/'.str_replace(' ','_',$alldata->title))}}">Product Details</a></li>
  </ul>
...
@if(!empty($alldata))
  ...
  <button type="button" class="btn btn-info" style="float:right;" data-toggle="modal" data-target="#myModal4"><span class="glyphicon glyphicon-edit"></span>&nbsp;Edit Product Data</button><br /><br />
...
<!-- Modal content-->
  ...
  <div class="modal fade" id="myModal4" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      {!! Form::open(['url' => 'admin/services/products/edit']) !!}
		{!! Form::hidden('id', $alldata->id) !!}
...
<!-- Modal content-->
      ...
      {!! Form::hidden('imgid', $image->id) !!}
       ...
       <a href="../image_delete/product/{{$image->media_name}}" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span></a>
...
<!-- Modal content-->
	  ...
	  {!! Form::hidden('title', $alldata->title) !!}
      {!! Form::hidden('service_type', 'product') !!}
		  <div class="form-group">
