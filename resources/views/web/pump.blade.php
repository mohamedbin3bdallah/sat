...
<link rel="stylesheet" type="text/css" href="{{asset('resources/assets/styles/contact_responsive.css')}}">
	...
	<div class="section_container">
					...
					<div class="head_form_container">
						<form action="{{url('form/pump')}}" method="post" class="head_form">
							<input type="hidden" name="form" value="pump" />
							{!! Form::token() !!}
							<div class="row">
							@if (!Auth::check())
								<div class="col-md-6">
							...
							@endif
								...
								<div class="col-md-12">
									<label>Head</label>
									<input type="text" name="head" class="input_item" placeholder="Head">
								</div>
								<div class="col-md-12">
