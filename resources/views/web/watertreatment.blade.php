...
<link rel="stylesheet" type="text/css" href="{{asset('resources/assets/styles/contact_responsive.css')}}">
	...
	<div class="section_container">
					...
					<div class="head_form_container">
						<form action="{{url('form/watertreatment')}}" method="post" class="head_form">
							<input type="hidden" name="form" value="watertreatment" />
							{!! Form::token() !!}
							<div class="row">
							@if (!Auth::check())
								<div class="col-md-6">
							...
							@endif
								...
								<div class="col-md-12">
									<label>Treated Water Quality Required</label>
									<input type="text" name="twqr" class="input_item" placeholder="Treated Water Quality Required">
								</div>
								<div class="col-md-12">
									<label>Raw Water Source & Quality</label>
									<input type="text" name="rwsq" class="input_item" placeholder="Raw Water Source & Quality">
								</div>
								<div class="col-md-12">
									<label>Notes</label>
